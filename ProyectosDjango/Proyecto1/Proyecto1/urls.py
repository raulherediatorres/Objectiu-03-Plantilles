...
from Proyecto1.views import saludo, habitant, despedida, dameFecha, calculaEdad, pagina1, pagina2, pagina3, informacion, nombreEdad
...
urlpatterns = [
    ...
    path('nombreEdad/<nombre>/<int:anyo>',nombreEdad),
]
